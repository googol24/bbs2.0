...
//System.out.println("searchParam:" + searchParam);
    ...
    // 取总页数
    ResultSet resultSet = DB.executeQuery(statement, "SELECT COUNT(*) FROM article WHERE pid=0" + searchSql);
    resultSet.next();
    ...
    resultSet = DB.executeQuery(statement, "SELECT * FROM article WHERE pid=0" + searchSql + " ORDER BY pdate DESC limit " + startPos + "," + pageSize);
...
<div id="jive-forumpage">
    ...
    <table border="0" cellpadding="3" cellspacing="0" width="100%">
        ...
        <tr valign="top">
          ...
          <a href="searchResult.jsp?page=1<%= searchParam %>">第一页</a></span></span>


                <span class="nobreak"><span class="jive-paginator">|</span></span>
                <span class="nobreak"><span class="jive-paginator">
          <a href="searchResult.jsp?page=<%=  pageNo - 1 %><%= searchParam %>">上一页</a>
          </span></span>

                <span class="nobreak"><span class="jive-paginator">| </span></span>
                <span class="nobreak"><span class="jive-paginator">
         <a href="searchResult.jsp?page=<%= pageNo + 1 %><%= searchParam %>">下一页</a>
          |&nbsp;
          <a href="searchResult.jsp?page=<%= totalPages %><%= searchParam %>">最末页</a> ] </span> </span></td>
        </tr>
        </tbody>
    </table>
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
