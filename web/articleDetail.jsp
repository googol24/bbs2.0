...
<%
    ...
    if (rs.next()) {
        article = new Article(id, rs.getInt("pid"), rs.getInt("rootid"), rs.getString("title"), rs.getTimestamp("pdate"), rs.getInt("isleaf"));
...
<div id="jive-flatpage">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr valign="top">
            <td width="99%"><p class="jive-breadcrumbs"><a href="http://bbs.chinajavaworld.com/index.jspa">首页</a> &#187;
                <a href="http://bbs.chinajavaworld.com/forumindex.jspa?categoryID=1">BBS 2.0 主题详情</a>
            </p>
                <p class="jive-page-title"> 主题: <%= article.getTitle() %>
                </p></td>
            <td width="1%">
    ...
    <div class="jive-buttons">
        <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
            <tbody>
            <tr>
                <td class="jive-icon"><a href="reply.jsp?id=<%= id %>&rootId=<%= article.getRootId()%>"><img
                        src="images/reply-16x16.gif" alt="回复本主题" border="0" height="16" width="16"></a></td>
                <td class="jive-icon-label"><a id="jive-reply-thread" href="reply.jsp?id=<%= id %>&rootId=<%= article.getRootId()%>">回复本主题</a>
                </td>
            </tr>
            </tbody>
        </table>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="jive-icon-label"><a
                                                                            href="reply.jsp?id=<%= id %>&rootId=<%= article.getRootId()%>"
                                                                            title="回复本主题">回复</a></td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
